...
const tokencost = (prompt(`How much do you want the box to be?`))
    ...
    document.getElementsByClassName('styles__boxHeaderText___UoHkq-camelCase').innerText = boxname;
    document.getElementsByClassName('styles__mysteryBoxIcon___18nWF-camelCase').style = `color: #${color};`;
    document.getElementsByClassName('styles__boxTokenText___1c1GF-camelCase').innerText = tokencost;        
